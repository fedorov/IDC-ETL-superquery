WITH
  ...
  SELECT
    ...
    aux.series_uuid as series_uuid,
    ...
    aux.instance_uuid as instance_uuid,
    ...
    aux.LicenseURL AS LicenseURL,
    aux.LicenseLongName AS LicenseLongName,
    aux.LicenseShortName AS LicenseShortName,
